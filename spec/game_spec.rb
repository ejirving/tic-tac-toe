module TicTacToe
  describe Game do
    ...
    context "#intialize" do
      ...
      it "selects the other player to go second" do
        allow_any_instance_of(Array).to receive(:shuffle) { [frank, bob] }
        game = Game.new([bob, frank])
    ...
    context "#solicit_move" do
      it "will ask the player to make a move" do
        allow_any_instance_of(Array).to receive(:shuffle) { [frank, bob] }
        game = Game.new([bob, frank])
        expect(game.solicit_move).to eq "frank: Enter a number to make your move"
      end
    end
    ...
    context "#game_over_message" do
      ...
      it "returns 'The game ended in a tie' if board shows a draw" do
        ...
        expect(game.game_over_message).to eq "It's a draw!"
      end
    end
  end
end
