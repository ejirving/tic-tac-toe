...
module TicTacToe
  describe Board do
    ...
    context "#grid" do
      it "returns the grid correctly" do
    ...
    context "#get_cell" do
      it "returns the value of the cell based on the given coordinate" do
        grid = [["", "", ""], ["", "", "something"], ["", "", ""]]
    ...
    context "#set_cell" do
      it "sets the value of the cell at the given coordinate" do
        grid = [[TestCell.new, "", ""], ["", "", ""], ["", "", ""]]
        board = Board.new(grid: grid)
        board.set_cell(0, 0, "X")
        expect(board.get_cell(0, 0).value).to eq x_cell.value
      end
    end
